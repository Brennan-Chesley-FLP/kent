...
Usage:
    ...
    python -m kent.driver.dev_driver.run --serve
...
async def cmd_run(args: argparse.Namespace) -> int:
    """Run the scraper."""
    from kent.driver.dev_driver import LocalDevDriver
...
async def cmd_status(args: argparse.Namespace) -> int:
    ...
    from kent.driver.dev_driver.models import Request, RunMetadata
...
async def cmd_errors(args: argparse.Namespace) -> int:
    """List errors."""
    from kent.driver.dev_driver.database import init_database
    from kent.driver.dev_driver.errors import list_errors
...
async def cmd_requeue_error(args: argparse.Namespace) -> int:
    ...
    from kent.driver.dev_driver.database import init_database
    from kent.driver.dev_driver.errors import resolve_error
...
async def cmd_resolve_error(args: argparse.Namespace) -> int:
    ...
    from kent.driver.dev_driver.database import init_database
    from kent.driver.dev_driver.errors import get_error, resolve_error
...
def cmd_serve(args: argparse.Namespace) -> int:
    ...
    logging.getLogger("kent.driver.dev_driver").setLevel(log_level)

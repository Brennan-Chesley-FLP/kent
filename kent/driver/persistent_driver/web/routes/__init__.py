...
from kent.driver.persistent_driver.web.routes.archived_files import (
...
from kent.driver.persistent_driver.web.routes.debug import (
...
from kent.driver.persistent_driver.web.routes.responses import (
    router as responses_router,
)
from kent.driver.persistent_driver.web.routes.results import (
    router as results_router,
)
from kent.driver.persistent_driver.web.routes.runs import (
    router as runs_router,
)
from kent.driver.persistent_driver.web.routes.scrapers import (
    router as scrapers_router,
)
from kent.driver.persistent_driver.web.routes.views import (
    router as views_router,
)
from kent.driver.persistent_driver.web.websocket import (
